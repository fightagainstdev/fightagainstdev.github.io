...
async function getUserMeta(uid) {
    ...
    const data = doc.exists ? doc.data() : { userName: '匿名用户', avatarUrl: 'https://fightagainstdev.github.io/default-avatar.png', followers: [] };
...
async function register() {
    ...
    try {
        ...
        await db.collection('users').doc(user.uid).set({
            ...
            avatarUrl: 'https://fightagainstdev.github.io/default-avatar.png',
            followers: [],
            following: [],
        ...
        uploadTask.on('state_changed', 
            ...
            async () => {
                ...
                await db.collection('stories').add({
                    ...
                    userAvatar: userData.avatarUrl || 'https://fightagainstdev.github.io/default-avatar.png',
                    photoUrl,
                    story,
                    tags,
