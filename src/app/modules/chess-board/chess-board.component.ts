...
import { MoveListComponent } from '../move-list/move-list.component'; // 导入 MoveListComponent
...
export class ChessBoardComponent implements OnInit, OnDestroy {
  ...
  public getPieceImagePath(piece: FENChar | null): string | undefined {
    if (!piece) return undefined;
    return this.pieceImagePaths[piece as FENChar];
  }
}